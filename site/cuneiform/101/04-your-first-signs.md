...
across two corpora in the [Nabu](https://arvicco.github.io/nabu/)
library — 36,501 lines of Sumerian literature (ETCSL) and 1.5 million
...
<table class="sign-table">
  <thead>
    <tr><th>Sign</th><th>Name</th><th>Key</th><th>Reads</th><th>Means</th><th>The shape's story</th></tr>
  </thead>
  <tbody>
    <tr>
...
**Write each five times**, largest wedges first, smallest last. For
<span class="script">𒀭</span>, press the crossing strokes through a
...
*Next: counting like a Sumerian — the number system built from the
three atomic wedges you just learned.*
