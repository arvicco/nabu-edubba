...
description: >-
  ...
  signs that fill, return, judge, and seize.
layout: chapter
course: cuneiform-102
chapter: 14
permalink: /cuneiform/102/14-a-row-of-proverbs/
...
them will have earned its seat before the row is done.
...
one of the warmest sentences Sumerian knows how to say:
...
Every ring in it is one you own, and they stack exactly in the
order the course taught them: wish, dative, doubled stem. When
Sumerians comforted each other, this is the sentence they reached
for — "may your heart go home."
...
1. Write 𒋛, 𒄄, 𒁲, 𒆪 from memory; say *si*, *gi₄*, *di*,
   *dab₅*.
2. Read the row straight through, covering the glosses. Then pick
   your favorite and explain its grammar to an imaginary
   schoolmate.
3. Name the three wish-rings and give each one's job in two words.
