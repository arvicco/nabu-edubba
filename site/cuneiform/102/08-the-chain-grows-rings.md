---
title: "08 · The chain grows rings"
short_title: "08 · The chain"
description: >-
  The verbal chain taken apart, piece by piece, as chapter 05
  promised: three new signs — ba, in, nu — and the finite prefixes
  and negation that turn a bare stem into a real Sumerian sentence.
layout: chapter
course: cuneiform-102
chapter: 8
permalink: /cuneiform/102/08-the-chain-grows-rings/
...
Five times each, aloud as you write: *ba*, *in*, *nu*.

## Grammar bite — the chain, ring by ring

A finite Sumerian verb chain — one that actually reports "he did"
...
(chapter 04's delivery line used exactly that reading). Here it
...
<figure class="composition">
  ...
  <figcaption class="citation">
    Schematic, built from your own inventory, not quoted from a
    tablet — the real quotation follows below. Two rings only: this
    verb has no suffix ring trailing after it.
  </figcaption>
</figure>
...
## Reading: the receipts' most important sentence

<figure class="reading reading--script">
  <div class="reading-lines">
    <div class="reading-line"><span class="script">𒇽 𒋗 𒁀𒋾</span><span class="translit">lu₂ šu ba-ti</span><span class="gloss">"the man received (it)" — person, hand, ba- coloring the verb toward the receiver, ti "approach"</span></div>
  </div>
  <figcaption class="citation">
    <em>NTSS</em> 114, ED IIIa (ca. 2600–2500 BCE), Šuruppak (mod.
    Fara), Arkeoloji Müzeleri, Istanbul.
    <a href="https://cdli.earth/artifacts/10490">CDLI P010490</a> via
    Nabu, <code>urn:nabu:cdli:p010490:obverse:4:2'</code> · license:
    attribution. The star sentence of the whole receipts genre —
    exactly the pattern the figure above assembled.
  </figcaption>
</figure>
...
<figure class="reading reading--script">
  ...
  <figcaption class="citation">
    ...
    uncertain, Oriental Institute, University of Chicago.
    <a href="https://cdli.earth/artifacts/10063">CDLI P010063</a> via
    Nabu, <code>urn:nabu:cdli:p010063:reverse:5:8</code> · license:
    attribution.
  </figcaption>
</figure>
...
<figure class="reading reading--script">
  ...
  <figcaption class="citation">
    ...
    composite of the Gilgameš cycle, quoted from ETCSL (ur-saj zu
    ur-saj nu-zu in ETCSL's own romanization, where <em>j</em> writes
    <em>ŋ</em>; this page's script and transliteration use the
    site's display convention throughout).
    <code>urn:nabu:etcsl:1.8.1.5.1:54</code> · license: ETCSL ·
    non-commercial.
  </figcaption>
</figure>

## Reading: the place where the lion ate a man

One more line, complete, real, and genuinely funny — a preview of
the genre the next chapter opens: a proverb about a lion that ate
someone, with every ring of this chapter's chain visible at once.

<figure class="reading reading--script">
  <div class="reading-lines">
    <div class="reading-line"><span class="script">𒆠 𒌨𒈤𒂊 𒇽 𒅔𒅥𒀀</span><span class="translit">ki ur-mah-e lu₂ in-gu₇-a</span><span class="gloss">"the place where the lion ate a man"</span></div>
  </div>
  <figcaption class="citation">
    <em>Proverbs: collection 5</em>, a Sumerian proverb composite,
    quoted from ETCSL. <code>urn:nabu:etcsl:6.1.05:D.5.67.31</code> ·
...
1. Write 𒁀, 𒅔, 𒉡 from memory; say *ba*, *in*, *nu*.
2. Read all five readings above cold, covering translit and gloss.
3. Say aloud, in order, the three rings of a Sumerian verb chain as
   this chapter named them — what comes first, what comes last, and
   which ring this chapter left, honestly, unopened.
4. Take *in-gu₇-a* apart on paper: which piece is the prefix, which
   the stem, which the trailing suffix — and which noun outside the
   verb (in either reading above) shows you what the action landed
   on.
5. Negate a verb of your own choosing from an earlier chapter's
   reading by adding *nu-* in front, in transliteration only, and
   say what it now means.

*Next: proverbs — the oldest jokes on earth, and the first whole
literary lines you will read start to finish.*
