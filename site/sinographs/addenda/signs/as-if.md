...
title: "ruò · as-if"
description: >-
  The character 若 in the Character Codex — a figure smoothing
  long hair, yielded into "to be like" and "if."
layout: sign
school: sinographs
sign: "as-if"
reads: "ruò"
...
permalink: /sinographs/addenda/signs/as-if/
---

## Where it comes from

The oldest forms draw a kneeling figure with both hands
smoothing long, loose hair — an image of yielding and going
...
<figure class="reading reading--script">
  ...
  <figcaption class="citation">
    <em>Laozi</em> 45.
    <code>urn:nabu:kanripo:KR5c0057:045:1a</code> · license: attribution.
  </figcaption>
</figure>
