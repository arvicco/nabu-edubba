...
Foundations gave you one, two, three, ten, and the myriad. This
...
<table class="sign-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>six</td>
      <td>by the received account a hut — sound borrowed, roof
      kept</td>
    </tr>
    <tr>
      ...
      <td>seven</td>
      <td>a stroke cut by another — the old "cut," lent to the
      number</td>
    </tr>
    <tr>
      ...
      <td>eight</td>
      <td>two strokes leaning apart — the old "divide," lent
      likewise</td>
    </tr>
    <tr>
...
telling his own life story — one number per decade, each a bare
predicate:
...
<figure class="reading reading--script reading--stacked">
  ...
  <figcaption class="citation">
    <em>Analects</em> 2.4 — five rungs of six. The seventieth,
    the ladder's crown, waits for this course's final chapter,
    when its last word is yours.
